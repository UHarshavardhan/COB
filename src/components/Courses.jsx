  ...
  return (
    <>
      <div className="flex justify-center items-center w-full mt-6">
        <div className="grid lg:grid-cols-3 grid-cols-1 lg:mx-10 mx-[5%] gap-5">
          {courseData.data.map((item, index) => (
            <div
              className="flex flex-row  w-[100%] h-[160px] rounded-lg shadow-[6px_6px_12px_6px_rgba(0,0,0,0.1)] border shadow-gray-300 "
              key={index}
            >
              <img
                src={item.image.src}
