...
import { getAllEnquiries } from '../../firebase/college_Enquireform'; // Adjust import path as needed
import ExportToExcel from './ExportToExcel';

const CollegeEnquireFormComponent = () => {
...
export default CollegeEnquireFormComponent;
